        ...
        'colis.insert'(code, bus, dest , amount, nameExp, telExp,nameDest, telDest, desc  ) {
            ...
            Colis.insert({
                ...
                if ( Meteor.isServer ) {
                    ...
                    const message = nameDest+', votre colis ('+code+') est en route, bus '+bus+'. Vous recevrez un sms a arrivee ; Si apres 05 ou 06h pas de sms recu, appelez le 697509899 ouvert 08h-19h. Livraisons 696849789'
