        ...
        'colis.insert'(code, bus, dest , amount, nameExp, telExp,nameDest, telDest, desc  ) {
            ...
            Colis.insert({
                ...
                if ( Meteor.isServer ) {
                    ...
                    const message =`${nameDest}, votre colis(${code}) est en route, bus ${bus}.Vous recevrez un sms a l'arrivee ; Renseignements 697509899. Livraisons 696849789 ; Ouvert 08h-19h.`
